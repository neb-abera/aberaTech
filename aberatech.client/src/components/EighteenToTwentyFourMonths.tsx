        ...
        <TimelineItem>
          ...
          <TimelineContent>
            ...
            >
              ...
              >
                <strong>
                  The earlier you can complete the Transition Assistance Program
                  (TAP) the better
                </strong>
                . I recommend completing TAP as early as possible. That's
                because not having a completed DD Form 2648 will prevent you
                from being able to schedule a Career Skills Program (CSP)
                internship.
              </Typography>
              <Typography
                variant="body1"
              ...
              >
                <strong>
                  Retiring soldiers can begin TAP 24 months out from their ETS.
                  Everyone else can begin TAP at 18 months from their
                  prospective ETS date
                </strong>
                . You start TAP by going to your installation's TAP center,
                registering for the program, and getting a counselor assigned.
              </Typography>
              <Typography
                variant="body1"
                component="p"
              ...
              >
                ...
                S fund. If you're older, or more risk-averse, choose "safer"
                funds.
              </Typography>
              <Typography
                variant="body1"
                ...
                sx={{ marginBottom: 2 }}
              >
                <strong>STORY ABOUT HOW I LEARNED THIS:</strong> I began TAP at
                ...
                she wouldn't give me the CSP documents until I was TAP complete.
                I then had to go back to my TAP counselor and tell her I needed
                her to re-schedule all of my appointments so that I could be
                done as quickly as possible. When I completed TAP at about the
                8-month mark, I found out that I had to get O6 approval for my
                CSP in Chicago since it was outside of a 50-mile radius from
                Fort Moore. Fort Moore also didn't have any CSP options
                available for my timeline (remote or in-person). I had to
                personally reach out to countless companies to create a CSP, and
                then get JAG and Installation Command approval. I even flew out
                to a job conference in DC to approach a Northrop Grumman
        ...
        <TimelineItem>
          ...
          <TimelineContent>
            ...
            >
              ...
              >
                <strong>
                  The most important skill to have is the ability to search for
              ...
              <Typography
                ...
                sx={{ marginBottom: 2 }}
              >
                Learn how to use google search to find what you need. I like to
                google to search Reddit and quora for the answers I'm looking
                for. Just add "Reddit" or "quora" to your search terms, and try
                to look for the most recent posts with the most discussion. The
                most upvoted answers are usually the best. The dissenting
        ...
        <TimelineItem>
          ...
          <TimelineContent>
            ...
            >
              ...
              >
                <strong>
                  Reach out to people after you have done your homework
                </strong>
              </Typography>
              <Typography
                variant="body1"
                ...
                sx={{ marginBottom: 2 }}
              >
                Use content creators on YouTube, TikTok, and Reddit to help your
                transition. Just use what you're interested in as a search term
          ...
          <TimelineContent>
            ...
            >
              <Typography
                ...
                sx={{ marginBottom: 2 }}
              >
                Use Credential Assistance (CA) to pay for relevant education. CA
                does not incur a service obligation for any soldier, including
                officers.{" "}
                <Link
                  to="https://home.army.mil/moore/About/garrison/DHR/TAP"
                  target="_blank"
          ...
          <TimelineContent>
            ...
            >
              ...
              <Typography
                ...
                sx={{ marginBottom: 2 }}
              >
                This is one of the intro videos they show you. You can go to
                this website to see an example of some of the classes you will
                take{" "}
                <Link
                  to="https://www.armytap.army.mil/"
                  target="_blank"
                  rel="noopener"
                >
                  TAP Online
          ...
          <TimelineContent>
            ...
            >
              <Typography sx={{ marginBottom: 2 }}>
                ...
                in your career (even if you let it go untreated). If you don't
                get follow-up treatments for something, later the VA will assume
                it didn't bother you so therefore it wasn't a problem.
              </Typography>

              <Typography sx={{ marginBottom: 2 }}>
                <span style={{ fontWeight: "bold" }}>
                  The best way to complete the VA disability process is through
                  the Benefits Delivery at Discharge (BDD) program when you're
                  between 180 and 90 days from your ETS.
                </span>{" "}
                The benefit of doing a BDD is that it will be substantially
                easier to get your benefits paid upon ETS. You will upload your
                medical record (which you will have to request at about the 7-8
                month mark), complete a physical, register a VA account, and
                initiate an online BDD claim.
              </Typography>

              <Typography sx={{ marginBottom: 2 }}>
                <span style={{ fontWeight: "bold" }}>
                  DO NOT PAY ANYBODY FOR ANY HELP WITH VA DISABILITY SERVICES.
                  THERE ARE A LOT OF SCAM ARTISTS WHO WILL TAKE YOUR MONEY
                </span>{" "}
                There are so many free resources that can help you. TAP has a
                good VA disability class, YouTube has some popular disability
          ...
          <TimelineContent>
            ...
            >
              ...
              >
                ...
                <Typography component="li" sx={{ marginBottom: 1 }}>
                  What do you want to do after you leave the Army? Do you want
                  to start a different career, pursue education, start your own
                  company, retire etc?
                </Typography>
                <Typography component="li" sx={{ marginBottom: 1 }}>
                  What are your priorities for your transition? How important is
                  moving to a specific location to you vs getting your dream job
                  vs maximizing total compensation etc?
                </Typography>
              </Typography>

              <Typography sx={{ marginBottom: 2 }}>
                Here are some books to help you think about what the next stage
                of your life can look like
              </Typography>

              <Typography sx={{ fontWeight: "bold", marginBottom: 2 }}>
                Immerse yourself in transition books, videos, and surround
                yourself with people willing to answer your questions
              </Typography>
          ...
          <TimelineContent>
            ...
            >
              <Typography sx={{ marginBottom: 2 }}>
                ...
                because you don't want to stand out during your job search. If
                you want to start your own business this is even more important.
              </Typography>

              <Typography sx={{ fontWeight: "bold", marginBottom: 2 }}>
                You want to give your future employer the impression that you're
                an experienced professional that is pivoting to another career.
              </Typography>

              <Typography sx={{ marginBottom: 2 }}>
                You don't want to give the impression that you're "starting
                over" as an entry-level employee. They'll assume you require
                extensive training, they're unsure if you'll be an asset to
                their organization, and they don't know if you have professional
                attributes (being on time, communicating expectations, teamwork
                etc.)
              </Typography>
        ...
        <TimelineItem>
          ...
          <TimelineContent>
            ...
            >
              ...
              <Typography sx={{ marginBottom: 1 }}>
                <Link
                  to="https://military.microsoft.com/mssa/"
                  target="_blank"
                  rel="noopener"
                >
              ...
              <Typography sx={{ marginBottom: 2 }}>
                You can find more by googling the company's name plus
                "SkillBridge" or "military transition."
              </Typography>

              <Typography sx={{ marginBottom: 2 }}>
                Some internships are competitive or have specific cohorts. Find
                ones that meet your timeline. You can also create your own CSP.{" "}
                <strong>
                  There are additional requirements to create your own CSP but
                  it'll be worth it.
                </strong>{" "}
                You can see the required documents if you scroll to the CSP
                portion below or go to the{" "}
                <Link
        ...
        <TimelineItem>
          ...
          <TimelineContent>
            ...
            >
              ...
              >
                <Typography component="li" sx={{ marginBottom: 1 }}>
                  <strong>Take it seriously</strong>, take notes, and
                ...
                <Typography component="li" sx={{ marginBottom: 1 }}>
                  <strong>
                    Tell your TAP counselor what date you want to be TAP
                    complete
                  </strong>{" "}
                  so that they can plan accordingly. They have the flexibility,
                  if there's availability, to move your appointments around so
        ...
        <TimelineItem>
          ...
          <TimelineContent>
            ...
            >
              ...
              <Typography sx={{ fontWeight: "bold", marginBottom: 2 }}>
                Understand how to have a productive 20-minute networking meeting
                or you will waste each other's time.
              </Typography>
              ...
              <Typography sx={{ marginBottom: 2 }}>
                ...
                by Perez and Ballinger. There is also an accompanying video in
                Handshake in USMA's Career Center Resources.
              </Typography>
        ...
        <TimelineItem>
          ...
          <TimelineContent>
            ...
            >
              ...
              <Typography sx={{ marginBottom: 2 }}>
                You need to know how to effectively find people and
              ...
              <Typography sx={{ fontWeight: "bold", marginBottom: 2 }}>
                I recommend looking at profiles of people that have jobs you're
                interested in or came from the same background as you.
              </Typography>
              <Typography sx={{ marginBottom: 2 }}>
                You can even reach out to them for a networking meeting to
                answer any questions you have. It's best to develop
                relationships in advance. You don't want to cold call someone
                and ask for a referral.
              </Typography>

              <Typography sx={{ fontWeight: "bold", marginBottom: 2 }}>
                Add/follow people that have jobs you're interested in, their
                managers, the company page, and the company's HR managers and
                recruiters.
              </Typography>

              <Typography sx={{ marginBottom: 2 }}>
                In some companies, managers do the hiring. In others, HR does
                the hiring. In some, both have a say in the process.
              </Typography>
          ...
          <TimelineContent>
            ...
            >
              ...
              <Typography
                ...
                sx={{ marginBottom: 2 }}
              >
                You can also take a look at LinkedIn's instructions for boolean
                search{" "}
