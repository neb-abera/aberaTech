      ...
      >
        ...
        <TimelineItem>
          ...
          <TimelineContent>
            ...
            >
              <Typography sx={{ marginBottom: 2 }}>
                You should have an idea of prospective jobs and/or companies by
                this point.{" "}
                <strong>
                  Start targeting specific companies and job titles to build a
                  network where you want to land.
                </strong>
              </Typography>
              <Typography sx={{ marginBottom: 2 }}>
                You can{" "}
              ...
              <Typography sx={{ marginBottom: 2 }}>
                <strong>
                  Get a joint email/calendar manager like Microsoft Outlook,
                  Google Calendar + Gmail, or a meeting manager like{" "}
                  <Link
          ...
          <TimelineContent>
            ...
            >
              ...
              <Typography sx={{ marginBottom: 2 }}>
                ...
                commander to do this (they usually keep example memos on site).
                If you are missing anything during your first turn-in, you can
                find the item at a local surplus store and then do a second
                turn-in when you get your installation clearing papers.
              </Typography>
            </Box>
          </TimelineContent>
        </TimelineItem>
          ...
          <TimelineContent>
            ...
            >
              ...
              <Typography sx={{ marginBottom: 2 }}>
                ...
                to break leases. It is customary, but not a requirement, to give
                a 30-day notice.{" "}
                <Link
