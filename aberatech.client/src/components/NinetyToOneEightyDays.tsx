          ...
          <TimelineContent>
            ...
            >
              ...
              <Typography sx={{ marginBottom: 2 }}>
                This is usually done at medical records at the installation
        ...
        <TimelineItem>
          ...
          <TimelineContent>
            ...
            >
              ...
              <Typography sx={{ fontWeight: "bold", marginBottom: 2 }}>
                Attend your installation's ETS brief, if it is a requirement by
                your higher headquarters' G1, as soon as possible.
              </Typography>
              <Typography sx={{ marginBottom: 2 }}>
                Sometimes these are done online, and sometimes they are done in
                person. Once complete, you can send a request for orders packet
                with your ETS briefing certificate to G1 through your BN S1. It
                will take G1 about 2 weeks to produce orders for you.
              </Typography>
              <Typography sx={{ marginBottom: 2 }}>
        ...
        <TimelineItem>
          ...
          <TimelineContent>
            ...
            >
              ...
              <Typography sx={{ marginBottom: 2 }}>
                Reach out to your G1 separations sections to get the most
                up-to-date information on separation requirements. For Fort
                Moore, you can find their contact info{" "}
                <Link
              ...
              <Typography sx={{ marginBottom: 2 }}>
                I was "waiting" for my orders for months without any believable
                updates from S1. I went to my unit's G1, DHR at Fort Moore, and{" "}
                <strong>
                  I found out that my packet was never submitted correctly by my
                  BN S1 so they weren't going to process it
                </strong>
                . That's because{" "}
                <strong>
                  they started requiring in-person ETS briefs THAT MONTH
                </strong>
                , after a two-year break due to COVID, and I wouldn't get my
                orders unless I attended their brief and received a certificate
                to put in my request for orders packet. This info had not been
                communicated down to the soldier level by BN S1s.{" "}
                <strong>
                  I had to drive 4 hours from a field training exercise to do
                  the ETS brief at Fort Moore, and then drive another 4 hours
          ...
          <TimelineContent>
            ...
            >
              <Typography sx={{ marginBottom: 2 }}>
                ...
                VA benefits <strong>AND</strong> apply for acceptance from the
                company.
              </Typography>
              <Typography sx={{ fontWeight: "bold", marginBottom: 2 }}>
                For VET TEC, find which company offers what you’re interested
                in, complete the train-up programs, then apply for acceptance.
              </Typography>
              <Typography sx={{ marginBottom: 2 }}>
                These are the{" "}
                <Link
              ...
              <Typography sx={{ marginBottom: 2 }}>
                Look at the benefits of an in-person course vs remote. You will
                get less BAH for remote vs in-person attendance. Let your social
                network know you'll be unavailable during the BootCamp.{" "}
                <strong>
                  To start the program, you need to be on terminal leave, DOD
        ...
        <TimelineItem>
          ...
          <TimelineContent>
            ...
            >
              ...
              <Typography sx={{ marginBottom: 2 }}>
                You'll need it to access VA resources, network, work from home,
                etc. There are many resources out there on desktop vs laptop and{" "}
                <Link
              ...
              <Typography sx={{ marginBottom: 2 }}>
                ...
                . This is especially important if you want to pursue a
                work-from-home or remote position.
              </Typography>
              <Typography sx={{ fontWeight: "bold", marginBottom: 2 }}>
                If you plan to do a VET TEC here are the usual computer
                requirements:
              </Typography>
              <Typography sx={{ marginBottom: 2 }}>
                Hack Reactor's computer requirements from their{" "}
                <Link
                  to="https://www.hackreactor.com/faq"
                  target="_blank"
                  rel="noopener"
                >
                  FAQ
              ...
              <Typography sx={{ marginBottom: 2 }}>
                ...
                another person (especially with another software developer)
                since you will be making system-level configuration changes, and
                possibly deleting information that will affect those users.
              </Typography>
              <Typography sx={{ fontWeight: "bold", marginBottom: 2 }}>
                Macs with Apple Silicon M1 are permitted in the immersive.
              </Typography>
              <Typography sx={{ marginBottom: 2 }}>
                <strong>Processor:</strong> Intel Dual-Core i5 or equivalent
                (minimum)
              </Typography>
              <Typography sx={{ marginBottom: 2 }}>
                <strong>Memory:</strong> 8 GB RAM (minimum), 16 GB RAM
                (recommended)
              </Typography>
              <Typography sx={{ marginBottom: 2 }}>
              ...
              >
                ...
                <Typography component="li" sx={{ marginBottom: 1 }}>
                  ...
                  - We do not provide full instructional support for Windows
                  users. Our staff can assist with WSL2/Ubuntu-related issues
                  but may be unable to troubleshoot Windows-specific issues.
                </Typography>
                <Typography component="li" sx={{ marginBottom: 1 }}>
                  <strong>Acceptable Alternative:</strong> Ubuntu Linux (LTS
                  minimum)
                </Typography>
              </Typography>
              <Typography sx={{ marginBottom: 2 }}>
          ...
          <TimelineContent>
            ...
            >
              <Typography sx={{ marginBottom: 2 }}>
                ...
                company-hosted conventions to network and find employment (e.g.,
                DEFCON, Blue Team CON).
              </Typography>
              <Typography>
                <Link
            ...
            >
              ...
              >
                ...
                <Typography sx={{ marginBottom: 1 }}>
                  Network with military-friendly companies interested in hiring
                  you.
                </Typography>
          ...
          <TimelineContent>
            ...
            >
              ...
              >
                ...
                <Typography sx={{ marginBottom: 1 }}>
                  Our hiring events connect military community job seekers from
                  around the globe with American businesses hiring for local,
                  national, and remote opportunities.
                </Typography>
                <Typography variant="body2" color="text.secondary">
          ...
          <TimelineContent>
            ...
            >
              <Typography sx={{ marginBottom: 2 }}>
                ...
                interested in. The reserve career counselors can send you a list
                to look through. You can also find the list of open positions on{" "}
                <Link
