 ...
 * ideas the whole subject rests on, the standards the transition is measured
 * against, the rules, the weekly cadence, then the three stages each with
 * its blocks, and last the bookshelf. Ticks and gate attempts are the
 * owner's and are saved to the server; a visitor and the build-time render
...
export default function StudyPlan() {
  ...
  return (
    <Stack spacing={5}>
      ...
      <Section title="The standards">
        <Typography variant="body2" sx={{ color: "text.secondary", mb: 1.5 }}>
          {copy.standards}
        </Typography>
        <TableContainer>
          <Table size="small" aria-label="The standards">
            <TableHead>
              <TableRow>
