    ...
    <PageShell {...props} title={guides[0].title} intro={guides[0].blurb}>
      ...
      >
        <Typography variant="body1" component="p" sx={{ marginBottom: 2 }}>
          ...
          videos. Please click on those to ensure that you understand the topic in its breadth and depth. This is a work
          in progress so feel free to send me questions, comments, and recommendations.
        </Typography>

        <Typography variant="body1" component="p" sx={{ marginBottom: 2 }}>
          I included some personal stories in this guide, that you can skip over if you're not interested, to illustrate
          the importance of some of these lessons. Please don't think that I did it to attack individual people in this
          guide. Most people do the best they can with the information and tools they have. But, you can have good
          people stuck in a bad bureaucratic system that causes unintended consequences for transitioning
          servicemembers. You will need to get the bureaucracy to work for you, not against you. Do not get discouraged
          by it. You need to advocate for yourself, your transition is worth fighting for.
        </Typography>
