    ...
    <PageShell {...props} title={guides[1].title} intro={guides[1].blurb}>
      ...
      >
        <Typography variant="body1" component="p" sx={{ marginBottom: 2 }}>
          The target audience for this are people in the military that are interested in working in tech, but don't know
          how to program. I made these guides during my transition from the Army to Software Development. The more I
          learn, the more I'll update. I embedded links, documents, and videos. I encourage you to click on those to
          ensure that you understand the topic in its breadth and depth. This is a work in progress so feel free to make
          send me questions, comments, and recommendations.{' '}
              ...
              <List>
                  ...
                  <ListItemText
                    primary={
                      <>
                        ...
                        operations. Make sure you stay actively engaged by doing the exercises, problem sets, etc. It's
                        easy to think you can learn from just watching the videos.. you can't. You learn by doing things
                        repeatedly
                      </>
                    }
                  />
                ...
                <ListItem>
                  <ListItemText
                    primary={
                      <>
                        <Link to="https://www.hackreactor.com/prep-programs" target="_blank" rel="noopener noreferrer">
                        ...
                        to watch if you get lost and need help. It is taught in JavaScript so it's only useful if you'd
          ...
          <Suspense fallback={<LoadingFallback />}>
            <Box sx={{ marginTop: 4 }}>
              <Typography variant="body1" gutterBottom>
                ...
                at. They also have solutions posted and a forum to discuss stuff. It’s also fun for kids because you get
                a “rank” and it’s fun to level up.
              </Typography>
              <Typography variant="body1" gutterBottom>
              ...
              <Typography variant="body1" component="ul" gutterBottom>
                ...
                <li>
                  ...
                  but you'll need to finish a DSA course before you'll be able to solve most of the problems. It's free.
                  I only recommend getting a subscription if you're REALLY interested in knowing what companies focus on
                  specific DSA problems.
                </li>
              </Typography>
            </Box>
          </Suspense>
          ...
          <Suspense fallback={<LoadingFallback />}>
            <Box sx={{ marginTop: 4 }}>
              <Typography variant="body1" gutterBottom>
                ...
                . Abdul Bari's course provides in-depth instruction with little problem solving, while Dr Moustafa's has
                concise instruction and lots of problem solving.
              </Typography>
              <Typography variant="body1" gutterBottom>
                ...
                an environment to code DSA in Python, JavaScript, and C++. Structy is a paid subscription by my favorite
                programming instructor. The website has videos, guides, lets you practice DSA problems, and has
                solutions all in one place. I found it very worth it. However, there is only one problem per topic so it
                lacks the depth of some of the other options.
              </Typography>
              <Typography variant="body1" gutterBottom>
                There are plenty of free resources online to learn DSA. You can get a free account on Structy and then
                just YouTube/Google the section title for free resources. I needed the easy access, accountability, and
                structure of the book and course to learn.
              </Typography>
              <Typography variant="body1" gutterBottom>
      ...
      <Accordion expanded={expanded === 'panel4'} onChange={handleAccordionChange('panel4')} sx={{ width: '100%' }}>
        ...
        <AccordionDetails>
          <Suspense fallback={<LoadingFallback />}>
            <Box sx={{ marginTop: 4 }}>
              <Typography variant="body1" gutterBottom>
                Thinking like a programmer is the most important part of learning to program. That’s why no matter what
                route you take in programming, you’ll learn the skills of a programmer. That's because memorizing
                programming language syntax does not make you a programmer; applying the problem-solving mindset is what
              ...
              <Typography variant="body1" component="ol" start={8} gutterBottom>
                <li>
                  ...
                  <ul>
                    ...
                    <li>If you get stuck for a reasonable amount of time, then allow yourself to use documentation</li>
                    <li>
      ...
      <Accordion expanded={expanded === 'panel5'} onChange={handleAccordionChange('panel5')} sx={{ width: '100%' }}>
        ...
        <AccordionDetails>
          <Suspense fallback={<LoadingFallback />}>
            <Box sx={{ marginTop: 4 }}>
              <Typography variant="body1" gutterBottom>
                You need to learn how to effectively search for the answer to your questions. The sum of human knowledge
                is at your fingertips, via a phone or computer; you just need to know how to sort and analyze relevant
                information. Being good at googling is a skill you should develop. You should always see what the best
                or most recommended way to do something is. Whether you’re buying a car, looking at how to learn a
                programming language, or solving a coding problem at an interview, it’s all the same problem-solving
                skill.
              </Typography>
              <Typography variant="body1" gutterBottom>
          ...
          <Suspense fallback={<LoadingFallback />}>
            <Box sx={{ marginTop: 4 }}>
              ...
              <Typography variant="body1" gutterBottom>
                ...
                best for you to understand a topic. You should use as many resources as it takes to find the best way to
                make a topic click for you. You can register for online courses, watch YouTube videos, get textbooks,
                read forums, etc.
              </Typography>
              <Typography variant="body1" gutterBottom>
                ...
                for ideas on what I should study. I disagree with how OSCS requires discrete math BEFORE data structures
                and algorithms. Math like discrete math and linear algebra are great to study once you're ready to do
                more than{' '}
              ...
              <Typography variant="body1" gutterBottom>
                AVOID PASSIVE "LEARNING" - This is one of the most common mistakes people make when they try to learn to
                program. You should spend more time "doing" than passively learning how to do something. Usually
          ...
          <Suspense fallback={<LoadingFallback />}>
            <Box sx={{ marginTop: 4 }}>
              <Typography variant="body1" gutterBottom>
                ...
                languages because you need better-suited tools for the tasks you're trying to accomplish. Just remember
                that specialization is more important, will get you better paid, and will make you a better programmer.
                You should have one or two languages you are an expert at, and then one or two that you are familiar
                with. I recommend learning the following languages so that you’re well-rounded:
              </Typography>
              <Typography variant="body1" component="ol" gutterBottom>
                <li>
                  ...
                  <ul>
                    <li>
                      ...
                      in. It is very easy to create programs quickly in Python. There are a lot of job opportunities. It
                      is very well supported. It is a growing language. It’s used in software development, data science,
                      artificial intelligence, and cyber security.
                    </li>
                    <li>
                      <strong>Cons:</strong> It is a high-level, interpreted, dynamically typed language, so you’ll need
                      another language if you want to work in high-performance, embedded, or systems programming. It is
                      a “slow” language compared to languages like C++.
                    </li>
                  </ul>
                </li>
                <li>
                  ...
                  <ul>
                    ...
                    <li>
                      <strong>Cons:</strong> It isn’t really useful for anything else. You can use frameworks to create
                      applications using JavaScript, but they will be slower/worse than their native counterparts.
                    </li>
                  </ul>
                </li>
                <li>
                  ...
                  <Typography variant="body1" gutterBottom>
                    ...
                    resource management. I think the greatest combination of languages to get the ability to do the most
                    while knowing the least amount of languages is C++,{' '}
        ...
        <AccordionDetails>
          <Suspense fallback={<LoadingFallback />}>
            <Box sx={{ marginTop: 4 }}>
              ...
              <Typography variant="body1" component="ol" gutterBottom>
                <li>
                  <strong>Staying organized:</strong> I had to start journaling key takeaways so that I don’t get lost,
                  storing stuff in bookmarks, using Outlook calendar, etc. I recommend that you download a joint
                  ...
                  to sync to your calendar, and then sync both of those to a video conferencing site like Zoom. That way
                  you can automatically update your calendar with important meetings/reminders and seamlessly
                ...
                <li>
                  ...
                  reference it later. The danger with videos/books is that you can think you “know” how to do something
                  by watching them. Don’t fall into that trap.
                </li>
              </Typography>
            </Box>
          </Suspense>
        ...
        <AccordionDetails>
          <Suspense fallback={<LoadingFallback />}>
            <Box sx={{ marginTop: 4 }}>
              ...
              <Typography variant="body1" gutterBottom>
                The intro material you choose will give you instructions on what they recommend to do for setup. Here is
                a list of{' '}
          ...
          <Suspense fallback={<LoadingFallback />}>
            <Box sx={{ marginTop: 4 }}>
              <Typography variant="body1" gutterBottom>
                ...
                graduate them to the recommendations above when they've shown interest and seem ready. The tough part of
                teaching kids is keeping them engaged and focused on one task for a set period of time. These websites
                try to make the learning process fun for kids. So, I think they are worth a shot. But, they don't teach
                actual coding, so they will eventually have to switch to something like the above recommendations.
                Programming involves sitting at a computer and problem-solving for extended periods of time. There's
                really no way around that, and some kids may not be into that. Teenagers may be ready to just jump into
                the recommendations above, but you can have them try the suggestions below to gauge their interest.
              </Typography>
              <Typography variant="body1" component="ul" gutterBottom>
                <li>
      ...
      <Accordion expanded={expanded === 'panel12'} onChange={handleAccordionChange('panel12')} sx={{ width: '100%' }}>
        ...
        <AccordionDetails>
          <Suspense fallback={<LoadingFallback />}>
            <Box sx={{ marginTop: 4 }}>
              <Typography variant="body1" gutterBottom>
                <strong>1. Software Development:</strong> Develop and maintain software products. This field is usually
                a money maker for companies, so it is treated well by corporate leadership. Software developers are
                typically highly paid and their roles are resistant to employment downturns. However, this career
                requires constant study and improvement to stay on top of trends. Not every company has software
                engineers, but the field is growing exponentially, and there is a significant demand for talent.
              </Typography>
              <Typography variant="body1" gutterBottom>
              ...
              <Typography variant="body1" gutterBottom>
                ...
                testing defenses by attempting to break in (red team). Cybersecurity roles usually offer higher pay than
                IT since it is a subspecialty requiring additional knowledge. Not all companies have dedicated
              ...
              <Typography variant="body1" gutterBottom>
                ...
                important because specialization is what gets you paid, but there are countless sub-fields, programming
                tools/languages, companies, etc. I recommend looking up the various fields and finding out what
                interests you. In the picture below, there are countless areas of specialization in each job title.
              </Typography>
              <Typography variant="body1" gutterBottom>
                If you don't know what to pick, you can just apply to a wide breadth of jobs and take whatever you get.
                You can worry about specialization after you figure out what you do and don't like at your first job.
              </Typography>
            </Box>
          </Suspense>
        </AccordionDetails>
          ...
          <Suspense fallback={<LoadingFallback />}>
            <Box sx={{ marginTop: 4 }}>
              ...
              <Typography variant="body1" component="ul" gutterBottom>
                ...
                <li>Passing the hiring assessments (usually they use sites like “LeetCode” or their own assessment)</li>
                <li>
              ...
              <Typography variant="body1" gutterBottom>
                You don't need a degree in computer science, IT, or cyber to get into those fields. The degree, and some
                certs, will matter most when you're looking for your first role in the industry. The degree will help
                you get your foot in the door, make you more competitive than your peers, probably give you relevant
                skills, and teach you “how to learn” and how you learn best. Getting a degree is great and makes you
                more competitive, but isn’t a requirement.
              </Typography>
              <Typography variant="body1" gutterBottom>
                Once you learn how to program, it’ll take you about 3-6 months, if you're dedicated, to learn data
                structures and algorithms well enough to pass “hard” level problems on LeetCode, which is what the MAANG
                companies require. If you want a regular web development job, you won’t even need to master data
                structures and algorithms. You could be employable after learning how to program with 6-12 months of
                practice. Some companies are willing to hire beginners and train them as junior developers, so you might
                get a job quickly after learning how to program.
              </Typography>
              <Typography variant="body1" gutterBottom>
                The key thing to know is that in these fields, what pays is experience. The better you are at your job,
                no matter what field, the more you’ll make. The top-level IT professionals make just as much, if not
                more, than software engineers. The important thing is to pick something that interests you, or that you
                could stand doing, and the money will come.
              </Typography>
              <Typography variant="body1" gutterBottom>
                ...
                specific site (the link is broken, but I’ve sent them a message). To answer your question, it depends on
                what part of software development you’re interested in. But generally, no one cares about certs past the
                first software development job. Certs and degrees will help candidates get their first entry-level job.
                After that, companies just look for years of experience and what you can build for them to make them
                money.
              </Typography>
              <Typography variant="body1" gutterBottom>
          ...
          <Suspense fallback={<LoadingFallback />}>
            <Box sx={{ marginTop: 4 }}>
              <Typography variant="body1" gutterBottom>
                ...
                plus a network to market yourself through. If you're interested in Software Engineering, the best thing
                you can do is to "grind LeetCode," publish software, and expand and utilize your network. You can do the
                majority of your networking via LinkedIn by finding veterans that are working in areas you're interested
                in. This is a good example of a resource I used early on from{' '}
              ...
              <Typography variant="body1" gutterBottom>
                ...
                to attend coding boot camps. These programs upskill you and have connections in technical job placement.
              </Typography>
              <Typography variant="body1" gutterBottom>
              ...
              <Typography variant="body1" gutterBottom>
                Remember that depending on the company, you will likely have to pass technical assessments to get a job
                offer. If you have a security clearance, it may make you a more attractive applicant to government
                contractors since clearances can save companies time and tens of thousands of dollars.
              </Typography>
              <Typography variant="body1" gutterBottom>
                However, these companies often do capital E Engineering, not typical web development, which has a lower
                bar to entry. This involves using STEM skills to optimize the performance of manufactured products,
                working in enterprise-scale teams, and adhering to legal and moral liabilities. They prefer STEM
                graduates. If you don’t have a STEM degree, preferably in Computer Science or Electrical Engineering,
                consider pursuing graduate studies to make yourself more appealing.
              </Typography>
              <Typography variant="body1" gutterBottom>
              ...
              <Typography variant="body1" component="ul" gutterBottom>
                ...
                <li>
                  <strong>Tech companies:</strong> Often reliant on investment. Hiring trends can shift based on market
            ...
            <Box sx={{ marginTop: 4 }}>
              ...
              <Typography variant="body1" component="ul" gutterBottom>
                ...
                <li>
                  ...
                  is the most updated, best organized, and most intuitive way I've found to learn C++. There's also lots
                  of hours of material. However, it lacks a problem-solving focus to force you into writing lots of C++.
                </li>
                <li>
                  <Link
                  ...
                  is how I was introduced to C++. It's a great resource but there are quicker, and more intuitive, ways
                  to learn C++ for self-taught folks. My critiques are that it sometimes uses concepts before they're
                  introduced, seems to pontificate on some subjects unnecessarily or too early, and isn't designed to
                  get folks quickly trained by focusing on what I think are "fundamental."
                </li>
                <li>
            ...
            <Box sx={{ marginTop: 4 }}>
              <Typography variant="body1" component="ul" gutterBottom>
                ...
                <li>
                  ...
                  is the best instructor I have found for understanding data structures and algorithms if you're into a
                  lecture format. The course is more about building data structures than using them and is light on
                ...
                <li>
                  ...
                  JavaScript, C++, and Python. While it has only one practice problem per topic, it’s great for learning
                  optimal ways to tackle problems. You’ll need other sites like LeetCode for additional problem-solving
                  practice.
                </li>
                <li>
                  <Link
          ...
          <Suspense fallback={<LoadingFallback />}>
            ...
            <Box sx={{ marginTop: 2 }}>
              ...
              <Typography variant="body1" gutterBottom>
                ...
                often enter the field from backgrounds in computer science, data science, math, neuroscience, etc. Some
                folks take the "hands-on" approach while others spend years attaining math maturity.
              </Typography>
              <Typography variant="body1" gutterBottom>
                ...
                industry, write down your priorities, make a 5- or 10-year plan, and backwards plan everything you need
                to do to be successful. Your daily actions should feed into your priorities.
              </Typography>
            </Box>
          </Suspense>
        </AccordionDetails>
