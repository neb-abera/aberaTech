  ...
  return (
    <PageShell {...props} title={guides[1].title} intro={guides[1].blurb}>
                  ...
                  <ListItemText
                    primary={
                      <>
                        ...
                        and algorithms. Math like discrete math and linear
                        algebra are great to study once you're ready to do more
                        than{" "}
                        <Link
                        ...
                        operations. Make sure you stay actively engaged by doing
                        the exercises, problem sets, etc. It's easy to think you
                        can learn from just watching the videos.. you can't. You
                  ...
                  <ListItemText
                    primary={
                      <>
                        ...
                        <Typography variant="body1" gutterBottom>
                          The first course focuses on long instruction and
                          limited practice, while the second is short on
                          instruction and focused on practice and problem
                          solving. I like Dr. Moustafa's course the most out of
                          all intro courses since it provides the best problem
                          solving foundation. He also provides follow-up courses
                          on data structures, algorithms, coding interviews, and
                          runs competitive programming instruction.
                        </Typography>
                      </>
                    }
                  />
      ...
      >
        <AccordionSummary expandIcon={<ExpandMoreIcon />}>
          <Typography>
            2. Include dedicated coding and problem-solving training in your
            schedule (daily repetition is best)
          </Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Suspense fallback={<LoadingFallback />}>
            <Box sx={{ marginTop: 4 }}>
              <Typography variant="body1" gutterBottom>
                ...
                language. Codewars is a free website that will give you problems
                to solve based on your skill level and the language you want to
                get better at. They also have solutions posted and a forum to
                discuss stuff. It’s also fun for kids because you get a “rank”
                and it’s fun to level up.
              </Typography>
              <Typography variant="body1" gutterBottom>
              ...
              <Typography variant="body1" gutterBottom>
                ...
                my methodology for training:
              </Typography>
              <Typography variant="body1" component="ol" gutterBottom>
                <li>Set a clock for 20 minutes</li>
                <li>
                  Try to solve the problem with limited use of documentation
                </li>
                ...
                <li>
                  Find a different problem and restart this process until I'm
                  done with the training session
                </li>
              </Typography>
              <Typography variant="body1" gutterBottom>
                You need to use sites to train your problem-solving and
              ...
              <Typography variant="body1" component="ul" gutterBottom>
                ...
                <li>
                  ...
                  has a lot of good problems to practice, but lacks the
                  structure of Codewars and I used up the free trial in like two
                  days
                </li>
                <li>
                  <Link
          ...
          <Suspense fallback={<LoadingFallback />}>
            <Box sx={{ marginTop: 4 }}>
              ...
              <Typography variant="body1" gutterBottom>
                ...
                Structy provides video instruction and an environment to code
              ...
              <Typography variant="body1" gutterBottom>
                ...
                get a free account on Structy and then just YouTube/Google the
                section title for free resources. I needed the easy access,
      ...
      >
        ...
        <AccordionDetails>
          <Suspense fallback={<LoadingFallback />}>
            <Box sx={{ marginTop: 4 }}>
              <Typography variant="body1" gutterBottom>
                Thinking like a programmer is the most important part of
              ...
              <Typography variant="body1" component="ol" gutterBottom>
                ...
                <li>
                  ...
                  <ul>
                    <li>
                      Optional: Make a Diagram (can "whiteboard" the problem. I
                      like to use pen and a notebook)
                    </li>
                  </ul>
                </li>
                <li>
              ...
              <Typography variant="body1" component="ol" start={8} gutterBottom>
                <li>
                  ...
                  <ul>
                    ...
                    <li>
                      If you get stuck for a reasonable amount of time, then
                      allow yourself to use documentation
                    </li>
                    <li>
                      If documentation doesn't help, then as a last resort
                      research what the best way to do each technique is
                    </li>
                  </ul>
                </li>
                <li>
                  ...
                  <ul>
                    <li>
                      Look up to see if there were better ways to do it and
                      re-try the problem using the optimal techniques
                    </li>
          ...
          <Suspense fallback={<LoadingFallback />}>
            <Box sx={{ marginTop: 4 }}>
              <Typography variant="body1" gutterBottom>
                ...
                buying a car, looking at how to learn a programming language, or
                solving a coding problem at an interview, it’s all the same
              ...
              <Typography variant="body1" gutterBottom>
                ...
                for the answers I'm looking for. Adding "Reddit" or "Quora" to
                your search terms, and looking for the most recent posts with
                the most discussion, will usually filter out the spam. The most
                upvoted answers are usually the best. The dissenting opinions
                are also important to understand.
              </Typography>
              <Typography variant="body1" gutterBottom>
                Most of my search results on any given day are probably "best
                ______ Reddit" or "best ______ Quora."
              </Typography>
            </Box>
          </Suspense>
        </AccordionDetails>
      ...
      >
        ...
        <AccordionDetails>
          <Suspense fallback={<LoadingFallback />}>
            <Box sx={{ marginTop: 4 }}>
              <Typography variant="body1" gutterBottom>
                Continue to develop your problem-solving skills, and study
                follow-on topics that interest you or that you want to work in.
              </Typography>
              <Typography variant="body1" gutterBottom>
                I recommend using{" "}
                <Link
              ...
              <Typography variant="body1" gutterBottom>
                Programming is just like any other skill. You're only good at
                what you repeatedly do. Find what works best for you to
                understand a topic. You should use as many resources as it takes
                to find the best way to make a topic click for you. You can
                register for online courses, watch YouTube videos, get
                textbooks, read forums, etc.
              </Typography>
              <Typography variant="body1" gutterBottom>
                You can get ideas on what to study from roadmaps like{" "}
                <Link
                  to="https://roadmap.sh/python"
                  target="_blank"
                  rel="noopener"
                >
                  roadmap.sh
                ...
                for ideas on what I should study. I disagree with how OSCS
                requires discrete math BEFORE data structures and algorithms.
                Math like discrete math and linear algebra are great to study
                once you're ready to do more than{" "}
                <Link
                  to="https://www.codecademy.com/article/what-is-crud"
                  target="_blank"
                  rel="noopener"
              ...
              <Typography variant="body1" gutterBottom>
                AVOID PASSIVE "LEARNING" - This is one of the most common
                mistakes people make when they try to learn to program. You
                should spend more time "doing" than passively learning how to do
                something. Usually spending &le;30% of your time
                reading/watching and &ge;70% coding.
              </Typography>
              <Typography variant="body1" gutterBottom>
                Here are two videos on mistakes beginners make. The first is
                from{" "}
                <Link
            ...
            <Box sx={{ marginTop: 4 }}>
              ...
              <Typography variant="body1" component="ul" gutterBottom>
                ...
                <li>
                  ...
                  . He went from having never coded to getting hired at Google
                  in 6 months. He also owns{" "}
                  <Link
                    to="https://algoexpert.io"
                    target="_blank"
                    rel="noopener"
                  >
                    AlgoExpert
                ...
                <li>
                  ...
                  . He is a talented software engineer that publishes about how
                  to get hired at tech companies.
                </li>
                <li>
      ...
      >
        ...
        <AccordionDetails>
          <Suspense fallback={<LoadingFallback />}>
            <Box sx={{ marginTop: 4 }}>
              <Typography variant="body1" gutterBottom>
                Once you learn your first programming language, you’ll find that
                you need to learn more programming languages because you need
                better-suited tools for the tasks you're trying to accomplish.
                Just remember that specialization is more important, will get
                you better paid, and will make you a better programmer. You
                should have one or two languages you are an expert at, and then
                one or two that you are familiar with. I recommend learning the
                following languages so that you’re well-rounded:
              </Typography>
              <Typography variant="body1" component="ol" gutterBottom>
                <li>
                  <strong>Python</strong>: a high-level general-purpose
                  language.
                  <ul>
                    <li>
                    ...
                    <li>
                      ...
                      dynamically typed language, so you’ll need another
                      language if you want to work in high-performance,
                      embedded, or systems programming. It is a “slow” language
                ...
                <li>
                  ...
                  <ul>
                    <li>
                      <strong>Pros:</strong> Web development is the easiest way
                ...
                <li>
                  ...
                  <Typography variant="body1" gutterBottom>
                    You'll need a more performant programming language if you
                    need to do work that requires serious performance or memory
                    management. If you{" "}
                    <Link
                    ...
                    learning it. If you're interested in competitive
                    programming, then I especially recommend C++. At this point,
                    you’ll have already learned one or two programming
                    languages, so picking up additional ones will be much easier
                    for you.
                  </Typography>
                  <Typography variant="body1" gutterBottom>
        ...
        <AccordionDetails>
          <Suspense fallback={<LoadingFallback />}>
            <Box sx={{ marginTop: 4 }}>
              ...
              <Typography variant="body1" component="ol" gutterBottom>
                <li>
                  <strong>Staying organized:</strong> I had to start journaling
                  key takeaways so that I don’t get lost, storing stuff in
                  bookmarks, using Outlook calendar, etc. I recommend that you
                  download a joint email/calendar manager like Microsoft
                  Outlook, get a meeting manager like{" "}
                  <Link
                ...
                <li>
                  ...
                  get distracted, so I found that I need accountability to stay
                  on track. I got an agenda and forced myself to follow a daily
                  routine, turned on “screen time” and notification limits on my
                  phone and computer, signed up for classes that have structure,
                  found friends online, and set appointments so I had a deadline
                  to force myself to get better by. You have your kid, so that’s
                  a good accountability buddy.
                </li>
                <li>
                  <strong>Learning the best way you learn:</strong> I’ve found
                  that I learn best from textbooks and using code-grind websites
                  to solve problems (like CodeWars or LeetCode). If you’re going
                  to use code-grind websites, set a 20-minute timer and try to
                  solve the problem with no help besides looking at the
                  documentation. Then look at the solution afterward and look up
                  anything you didn’t know. I’ve found that I learn best by
                  working through a textbook and then YouTubing anything I don’t
                  understand right away. I buy textbooks because I like knowing
                  the “why” behind stuff, and I can bookmark it and reference it
                  later. The danger with videos/books is that you can think you
                  “know” how to do something by watching them. Don’t fall into
                  that trap.
                </li>
              </Typography>
            </Box>
          ...
          <Suspense fallback={<LoadingFallback />}>
            <Box sx={{ marginTop: 4 }}>
              <Typography variant="body1" gutterBottom>
                ...
                Community or XCode for Apple until you know enough to move on.
                If I'm not using Visual Studio Community, I like to use{" "}
                <Link
              ...
              <Typography variant="body1" gutterBottom>
                ...
                to practice programming if you're intimidated by setting up a
              ...
              <Typography variant="body1" gutterBottom>
                ...
                <Link
                  ...
                  rel="noopener"
                >
                  common text editors and integrated development environments
                  (IDEs)
                </Link>
                .
              </Typography>
      ...
      >
        ...
        <AccordionDetails>
          <Suspense fallback={<LoadingFallback />}>
            <Box sx={{ marginTop: 4 }}>
              <Typography variant="body1" gutterBottom>
                If you have smaller kids, then I recommend getting them to try
                the recommendations below. You can graduate them to the
              ...
              <Typography variant="body1" component="ul" gutterBottom>
                ...
                <li>
                  ...
                  is MIT's attempt to appeal to kids. Kids can learn to program
                  by dragging and dropping stuff to make stories and programs.
                  It isn't as gamified as CodeCombat but still seems like it
      ...
      >
        <AccordionSummary expandIcon={<ExpandMoreIcon />}>
          <Typography>
            My subjective opinion on working in three popular areas in tech
            (software development, IT, cyber)
          </Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Suspense fallback={<LoadingFallback />}>
            <Box sx={{ marginTop: 4 }}>
              ...
              <Typography variant="body1" gutterBottom>
                ...
                network from infiltration (blue team) or testing defenses by
                attempting to break in (red team). Cybersecurity roles usually
                offer higher pay than IT since it is a subspecialty requiring
                additional knowledge. Not all companies have dedicated
                cybersecurity teams, and some only prioritize it after
                experiencing an attack. Despite this, cybersecurity is a rapidly
                growing field with an increasing demand for talent.
              </Typography>
              <Typography variant="body1" gutterBottom>
                Here is a{" "}
                <Link
              ...
              <Typography variant="body1" gutterBottom>
                You'll eventually need to figure out what field of computer
                science you want to work in. This is important because
                specialization is what gets you paid, but there are countless
                sub-fields, programming tools/languages, companies, etc. I
                recommend looking up the various fields and finding out what
                interests you. In the picture below, there are countless areas
                of specialization in each job title.
              </Typography>
              <Typography variant="body1" gutterBottom>
                If you don't know what to pick, you can just apply to a wide
                breadth of jobs and take whatever you get. You can worry about
                specialization after you figure out what you do and don't like
                at your first job.
              </Typography>
            </Box>
          </Suspense>
      ...
      >
        <AccordionSummary expandIcon={<ExpandMoreIcon />}>
          <Typography>
            What matters most for getting a Software Engineering job? Do
            certifications, degrees, or skills matter for getting a job in the
            industry
          </Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Suspense fallback={<LoadingFallback />}>
            <Box sx={{ marginTop: 4 }}>
              <Typography variant="body1" gutterBottom>
                For jobs in computer science fields, the most important things
                are:
              </Typography>
              <Typography variant="body1" component="ul" gutterBottom>
                <li>
                  Relevant job experience using the software stack and skills
                  they are hiring for
                </li>
                <li>
                  Years of experience in that specific field using adjacent
                  stacks and skills
                </li>
              ...
              <Typography variant="body1" gutterBottom>
                ...
                into those fields. The degree, and some certs, will matter most
                when you're looking for your first role in the industry. The
                degree will help you get your foot in the door, make you more
                competitive than your peers, probably give you relevant skills,
                and teach you “how to learn” and how you learn best. Getting a
                degree is great and makes you more competitive, but isn’t a
                requirement.
              </Typography>
              <Typography variant="body1" gutterBottom>
                Once you learn how to program, it’ll take you about 3-6 months,
                if you're dedicated, to learn data structures and algorithms
                well enough to pass “hard” level problems on LeetCode, which is
                what the MAANG companies require. If you want a regular web
                development job, you won’t even need to master data structures
                and algorithms. You could be employable after learning how to
                program with 6-12 months of practice. Some companies are willing
                to hire beginners and train them as junior developers, so you
                might get a job quickly after learning how to program.
              </Typography>
              <Typography variant="body1" gutterBottom>
                The key thing to know is that in these fields, what pays is
                experience. The better you are at your job, no matter what
                field, the more you’ll make. The top-level IT professionals make
                just as much, if not more, than software engineers. The
                important thing is to pick something that interests you, or that
              ...
              <Typography variant="body1" gutterBottom>
                ...
                guide for what skills you need to learn. I used to use a
                specific site (the link is broken, but I’ve sent them a
                message). To answer your question, it depends on what part of
                software development you’re interested in. But generally, no one
                cares about certs past the first software development job. Certs
                and degrees will help candidates get their first entry-level
                job. After that, companies just look for years of experience and
                what you can build for them to make them money.
              </Typography>
              <Typography variant="body1" gutterBottom>
      ...
      >
        <AccordionSummary expandIcon={<ExpandMoreIcon />}>
          <Typography>
            How do you get a technical job in the tech industry as a veteran or
            service member
          </Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Suspense fallback={<LoadingFallback />}>
            <Box sx={{ marginTop: 4 }}>
              ...
              <Typography variant="body1" gutterBottom>
                By "grind LeetCode," I mean mastering data structures and
                algorithms in a programming language and grinding coding
                challenges on popular sites like LeetCode. Consider using{" "}
                <Link
              ...
              <Typography variant="body1" gutterBottom>
                ...
                . BreakLine’s purpose is to help veterans, minorities, and women
                get into high-paying tech roles. This is one of the best ways to
                secure a tech job.
              </Typography>
              <Typography variant="body1" gutterBottom>
                Remember that depending on the company, you will likely have to
                pass technical assessments to get a job offer. If you have a
                security clearance, it may make you a more attractive applicant
                to government contractors since clearances can save companies
              ...
              <Typography variant="body1" gutterBottom>
                ...
                graduates. If you don’t have a STEM degree, preferably in
                Computer Science or Electrical Engineering, consider pursuing
              ...
              <Typography variant="body1" component="ul" gutterBottom>
                <li>
                  <strong>Corporations:</strong> Always optimizing for profit.
                  They value exceptional performance and proven results. They
                  seek 10xers or unicorns and prefer safe bets when hiring.
                </li>
                <li>
                  <strong>NGC (Northrop Grumman):</strong> Specializes in
                  aerospace and defense projects. Involves strict legal and
                  ethical requirements. Focused on professional Engineering with
                  complex problems rooted in math, physics, and systems
                  engineering.
                </li>
                <li>
                  <strong>Tech companies:</strong> Often reliant on investment.
                  Hiring trends can shift based on market conditions and
                  interest rates.
                </li>
                <li>
              ...
              <Typography variant="body1" component="ul" gutterBottom>
                ...
                <li>
                  Security clearance (an advantage if you already have one)
                </li>
                <li>
                ...
                <li>
                  Education (relevant course of study and institutional
                  reputation)
                </li>
                <li>
        ...
        <AccordionDetails>
          <Suspense fallback={<LoadingFallback />}>
            <Box sx={{ marginTop: 4 }}>
              ...
              <Typography variant="body1" component="ul" gutterBottom>
                <li>
                  An article from Alex Nguyen on the resources he uses to
                ...
                <li>
                  An article from Alex Nguyen on his system for solving problems
                ...
                <li>
                  A video from Clement Mihailescu on the most important concepts
                ...
                <li>
                  ...
                  haven't tried it yet, so I can't give my personal
                  recommendation for it. I've heard it is a great product but
                  lacks systems design and should be used in tandem with
                  products like Cracking the Coding Interview and Elements of
                  Programming Interviews. I'll give it a try when I get ready
                  for technical interviews in about six months.
                </li>
              </Typography>
            </Box>
          </Suspense>
            ...
            <Box sx={{ marginTop: 4 }}>
              ...
              <Typography variant="body1" component="ul" gutterBottom>
                <li>
                  ...
                  by Dr. Moustafa Saad Ibrahim is the most concise way to learn
                  C++ and develop problem-solving skills at the same time. The
                  emphasis is on short lectures and lots of problem-solving.
                </li>
                <li>
                  <Link
                    to="https://www.udemy.com/course/beginning-c-plus-plus-programming/"
                  ...
                  is the most updated, best organized, and most intuitive way
                  I've found to learn C++. There's also lots of hours of
                  material. However, it lacks a problem-solving focus to force
                  you into writing lots of C++.
                </li>
                <li>
                  <Link
                  ...
                  is how I was introduced to C++. It's a great resource but
                  there are quicker, and more intuitive, ways to learn C++ for
      ...
      >
        <AccordionSummary expandIcon={<ExpandMoreIcon />}>
          <Typography>
            What data structures and algorithms resources have I personally
            purchased or used
          </Typography>
        </AccordionSummary>
        <AccordionDetails>
            ...
            <Box sx={{ marginTop: 4 }}>
              <Typography variant="body1" component="ul" gutterBottom>
                <li>
                  ...
                  . He is a competitive programming coach and knows what it
                  takes to excel at problem-solving and DSA. His courses have a
                  higher bar of entry for programming familiarity and are
                  focused on using data structures and algorithms to solve
                  problems.
                </li>
                <li>
                  Abdul Bari's{" "}
                  ...
                  course is more about building data structures than using them
                  and is light on algorithms or ways to try out the topics
                  you've learned. Supplementing with other resources like
                ...
                <li>
                  ...
                  is an excellent one-stop shop for DSA and common operations in
                  an interview format. It covers JavaScript, C++, and Python.
                  While it has only one practice problem per topic, it’s great
                  for learning optimal ways to tackle problems. You’ll need
                  other sites like LeetCode for additional problem-solving
                  practice.
                </li>
                <li>
                  <Link
      ...
      >
        <AccordionSummary expandIcon={<ExpandMoreIcon />}>
          <Typography>
            What technical interview resources have I personally purchased or
            used
          </Typography>
        </AccordionSummary>
        <AccordionDetails>
            ...
            <Box sx={{ marginTop: 4 }}>
              ...
              <Typography variant="body1" component="ul" gutterBottom>
                ...
                <li>
                  ...
                  teaches the basics quickly and then dives into building
                  projects. The approach forces learners to build and figure
                  things out independently. It’s a great resource for learning
                  practical skills and projects, although it may not suit
      ...
      >
        <AccordionSummary expandIcon={<ExpandMoreIcon />}>
          <Typography>
            What other career-related resources have I personally purchased or
            used
          </Typography>
        </AccordionSummary>
        <AccordionDetails>
      ...
      >
        <AccordionSummary expandIcon={<ExpandMoreIcon />}>
          <Typography>
            What computer science-related books have I personally purchased or
            read for fun
          </Typography>
        </AccordionSummary>
        <AccordionDetails>
      ...
      >
        <AccordionSummary expandIcon={<ExpandMoreIcon />}>
          <Typography>
            What Artificial Intelligence (Machine Learning) resources have I
            used?
          </Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Suspense fallback={<LoadingFallback />}>
            ...
            <Box sx={{ marginTop: 2 }}>
              ...
              <Typography variant="body1" gutterBottom>
                ...
                Learning, and Deep Learning describe an emerging
                interdisciplinary field that takes years of study and practice
                to become competent in. People often enter the field from
                backgrounds in computer science, data science, math,
                neuroscience, etc. Some folks take the "hands-on" approach while
              ...
              <Typography variant="body1" gutterBottom>
                ...
                a 5- or 10-year plan, and backwards plan everything you need to
                do to be successful. Your daily actions should feed into your
                priorities.
              </Typography>
            </Box>
          </Suspense>
